            ...
            <div className="row mx-0">
                ...
                <div className="col-md-6 py-5 frame-height overflow-y-auto">
                    <div className="col-md-8 px-md-0 mx-auto d-flex flex-column h-100">
                        ...
                        <input type="checkbox" id="calendar_up_to_date" name="got_it" className="ng-valid ng-dirty ng-touched" value={check} required onChange={(e: any) => {setCheck(e.target.checked)}}/>
