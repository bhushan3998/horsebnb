    ...
    return (
        <>
            <nav className="navbar navbar-expand-lg navbar-light px-4 d-flex">
                ...
                <button type="button" data-toggle="collapse" data-target="#navbarColor03" aria-controls="navbarColor03" aria-expanded="false" aria-label="Toggle navigation" className="navbar-toggler">
